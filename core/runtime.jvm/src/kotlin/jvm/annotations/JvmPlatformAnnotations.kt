...
/**
 * Changes the fully qualified name of the JVM package where the .class file for this file is generated into.
 ...
 * If a file is annotated with this annotation, it can only have function and property declarations, but no classes.
 */
@Target(AnnotationTarget.FILE)
@Retention(AnnotationRetention.SOURCE)
@MustBeDocumented
